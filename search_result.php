...
<div class="container mt-5">
	<p align="center">search results for the product <b><?php echo "$find";?></b> are shown bellow</p>
	<div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4">
			<?php
				$query = "SELECT * FROM tb1_product WHERE name like '$find'";
			...
			?>
			<p align="center">No results found for the product <b><?php echo "$find";?></b></p>
		<?php } ?>
	</div>
</div>
</body>
